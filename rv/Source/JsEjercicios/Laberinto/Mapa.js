...
Environment.prototype.setMap=function(map){
  ...
  for(var j=0;j<(map.length)-1;j++){
    ...
    if(map[i][j]=="F"){
     this.add(new Meta(1,j-_offset,-(i-_offset),(0.3/1)+(0.2/1)));
  }
  }
}
...
function setup(){
  ...
  camara=new THREE.PerspectiveCamera(10, window.innerWidt/ hwindow.innerHeight, 1, 10000 );//(10, window.innerWidt/ hwindow.innerHeight, 1, 10000 );
  //Luces
 luzPuntual=new THREE.PointLight(0xFFFFFF,0.5,10,0.01,1,2);
