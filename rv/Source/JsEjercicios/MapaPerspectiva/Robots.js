...
this.Camara.position.z=z+(0.4/Tmaño)+(0.1/Tmaño)+(0.5/Tmaño)+(0.3/Tmaño)+(1/Tmaño);
...
this.Rostro= new THREE.Mesh(new THREE.BoxGeometry(0.25/Tmaño,1/Tmaño,0.25/Tmaño),new THREE.MeshPhongMaterial({map: texturaR}));
this.Rostro.position.y=0.5/y;
var AR=1/Tmaño;//Altura Rostro
this.Rostro.position.z=z+(0.25/Tmaño)+(0.5/Tmaño)+(1/Tmaño);

var texturaO= THREE.ImageUtils.loadTexture('http://miguel26.github.io/rv/imagen3.jpg');
this.OrejaI= new THREE.Mesh(new THREE.BoxGeometry(0.2/Tmaño, 0.25/Tmaño, 0.5/Tmaño ),new THREE.MeshPhongMaterial({map: texturaO}));
...
this.OrejaD.position.x=0.75/x;
this.OrejaD.position.y=0.5/y;
this.OrejaD.position.z=z+0.25+(1/Tmaño)+(0.5/Tmaño)+(0.3/Tmaño);
