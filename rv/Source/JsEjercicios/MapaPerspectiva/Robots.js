...
this.PiernaI= new THREE.Mesh(new THREE.BoxGeometry(Tmaño/0.1,Tmaño/0.3,Tmaño/1),new THREE.MeshPhongMaterial({map: texturaPn}));
this.PiernaI.position.x=-0.3+x;
this.PiernaI.position.y=0.5/y;
this.PiernaI.position.z=z;

this.PiernaD= new THREE.Mesh(new THREE.BoxGeometry(Tmaño/0.1,Tmaño/0.3,Tmaño/1),new THREE.MeshPhongMaterial({map: texturaPn}));
